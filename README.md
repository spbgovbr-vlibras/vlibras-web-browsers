...
![image](https://i.postimg.cc/KYZBC89L/banner.png)
...
- **[Node.js](https://nodejs.org/)** (versão v22 ou superior)
...
1. **Faça o clone do repositório**:
   ...
   ```bash
   git clone https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-widget-plus.git
...
> Antes de tudo, certifique-se que o link para a build em produção no arquivo `/src/scripts/vlibras-widget-plus.js` está correto.
...
> Este comando também pergunta se você deseja criar a _tag_ da nova versão. Caso aceite, ao ser criada, deve ser feito o _push_ dela (a criação da _tag_ também pode ser feita pelo GitLab).
