...
# [7.13.0](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/compare/v7.12.2...v7.13.0) (2026-09-24)

### Bug Fixes

* **a11y:** add accessible names for dialogs and screens and expose expanded state on triggers ([d493da4](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/d493da46d5ecd8ec1a8f37a8b42075212343eedb))
* **a11y:** add accessible names to social links and dictionary search ([a76e9f2](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/a76e9f281921821a2c9ad079a4de7d77b4239551))
* **a11y:** add combobox/listbox semantics to feedback suggestions ([40751fa](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/40751fa01def582b3b69faa7e3bd77a8cc07ad19))
* **a11y:** add contextual names to inline translator buttons ([7694873](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/7694873ecfb1a46d1a3c8bc1ec8a609ce2684748))
* **a11y:** add keyboard dragging and a reachable, focus-safe avatar toggle ([ce0b9f5](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/ce0b9f58f642542232dadaaf1bdd37836b11bca0))
* **a11y:** add non-color state, translator ctrl+enter, reduced motion, and close labels ([837eb63](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/837eb63fd0a61dd7bd15db951dd47b7d127f0285))
* **a11y:** add roving tabindex to menu dropdowns ([f0ee42b](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/f0ee42bca621e1fabc103409f8b0e251c42ca59e))
* **a11y:** add visual-only tooltip mode and name icon-only controls ([300a599](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/300a59915c095efaa59ccca5d99ed9911f2bf6ad))
* **a11y:** announce dialog loading fallback to screen readers ([386f332](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/386f332ebf3be391a00d6bc7e70f7d59a273498a))
* **a11y:** announce status via live regions and complete progressbars ([4733980](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/4733980cd7206cead7c741eb9052dc41f1940a9d))
* **a11y:** associate tooltip with trigger and add menu semantics to dropdowns ([ee717bf](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/ee717bf6aa8649d99587a83d9b126b73f50fe430))
* **a11y:** document escape dismissal in consent banner ([e6d7dbe](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/e6d7dbec698fea7e20d85730a06876a735f16025))
* **a11y:** expose dictionary filter state with aria-pressed ([b6a9bce](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/b6a9bce352c455d754625ed863434f5033bff749))
* **a11y:** expose guide as dialog with live step announcements ([aa0ea38](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/aa0ea38a633f2389c4fb078ff829787b00a37eb1))
* **a11y:** hide redundant drag handle from tab order and extensions ([3cf948b](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/3cf948bdce4cfa9f2f0cd674263fab269d2e6bd6))
* **a11y:** include current value in speed control name ([6cd163d](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/6cd163d1a60c2fd944cc5ba5738a38b0f012ddc4))
* **a11y:** keep focus in guide on avatar step ([6c0b6a9](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/6c0b6a9a014b0e7b4868effd1207dcfd8532ca51))
* **a11y:** keep the drag handle from covering interactive controls ([8070d77](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/8070d77504f957a9399350d7a5636ef353c60ce6))
* **a11y:** make consent banner a true modal dialog ([69de4d4](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/69de4d4d7b00e34b72508c78b8a1093fba531dd6))
* **a11y:** mark loader popup decorative and respect reduced motion ([ee7e11b](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/ee7e11bc828e90aa25f650294def8bcb03e45cbc))
* **a11y:** move focus on open, trap tab, and restore focus for widget, dialogs, screens, and banners ([8df50ec](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/8df50ecb735a177744db80d6218f8ec67071d42e))
* **a11y:** polish widget close button aria label ([9a96543](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/9a96543f21e607b70bb642eb53e2a8317ead81c1))
* **a11y:** set lang on shadow root containers ([0441aff](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/0441affbe2f564fe3d06e036609d345509df3fce))
* **a11y:** stop opening dropdowns automatically on focus ([9a7a23c](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/9a7a23c61064f293e96df514a56555e3bda05670))
* **a11y:** translate spinner screen reader text to portuguese ([c44c9d8](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/c44c9d8e1cf92297cea4d3b950c28066dbb0acfd))
* **a11y:** use native radio group for regionalism selector ([1a8cf08](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/1a8cf081b6a48d8436b8f0da3c75748925c9069f))
* **a11y:** use real labels for theme and opacity settings ([2a41879](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/2a418791eccbc9ba6cd54fba1f0e0d0c2f64cbd5))
* **a11y:** use valid menu group structure in dropdowns ([9ecad2c](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/9ecad2c685318c4b1dcb67428cb7b1229e16261c))
* **ci:** replace private gitlab coverage badge with static badge ([663f11a](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/663f11ab109da316711862d56c83ca39869f302b))
* **ci:** scope vite dependency scan to the demo entry ([db2dd5e](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/db2dd5e42193d4dfe47b3d6898911c59b8bf0400))
* **common:** add `setTimeout` fallback when `requestAnimationFrame` never fires ([261a9d9](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/261a9d9ac554b01d42eca64f30f1e41b682908ec))
* **demo:** set html lang to pt-br and remove nested interactive ([35b8d2b](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/35b8d2be5b2e1ba6ca04793cdc92139e24a9f0c1))
* **deps:** patch security vulnerabilities ([7893ca6](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/7893ca6db490291128404ed4afc352e52f1f1731))
* **lint:** format a11y-review scanner script to satisfy biome check ([cbd012e](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/cbd012e74bf96f7d9c86b05a251c365e3050171b))
* **testing:** lower coverage thresholds to match actual measured coverage ([c555fb7](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/c555fb7673b27b9d5667f49cf00bb8abddc6a483))
* **testing:** remove unsupported coverage.all option and type-check vitest config ([8252df6](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/8252df66ae76c08c26ffe67b67e216ffce1e5835))
* **text-capture:** keep tooltip inside viewport near edges ([09f14ce](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/09f14ce498f151e49b7e639aac794e49cac8699c))
* **widget:** add -webkit-mask-image prefix for safari/ios webp rendering ([31c911f](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/31c911f2002ffeb534e1c9bc3df5a493032bd6ac))
* **widget:** render icon tint via drop-shadow instead of mask-image ([ed725b3](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/ed725b35810435d7011c90a55985b15d55406230))
* **widget:** scope text capture cursor to hovered element only ([be6fd07](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/be6fd0745dc24e851b96d59dbcc489c0f6009f41))

### Features

* **ci:** add script to update the coverage badge in readme ([5e8b067](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/5e8b0673aafcb927180f1e23014aeee72c29830e))
* **loader:** add optional `showButton` config and toggle method ([a2d2d3a](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/a2d2d3a9f4974ac8ff0a541c3692af641bc282cc))
* **release:** add idempotent fix-forward release sync ([1164890](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/1164890bff7b57311e188c3a078f8960fa4e14ab))
* **scripts:** commit coverage badge updates and colorize the change ([dbf5cd9](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/dbf5cd92ced9c071c20d9b1bc46dd3602f34ae6a))
* **skills:** add create-commit skill and relocate skills under .claude ([9330dbf](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/9330dbf80f665dec85089a9e94a1b704e3c7e363))
* **skills:** add generic accessibility review skill ([6371b7b](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/6371b7bbaad0f7400dd5efd03fc7208874358379))
* **testing:** add component tests and e2e smoke ([53d8474](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/53d84747ed1775eff89277a08829d90ca69b00f8))
* **testing:** add component tests for widget UI, dialogs, and dictionary screens ([46a0872](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/46a087277785d5297fc8286c02879a0b8d7e4e5d))
* **testing:** add coverage infrastructure and thresholds ([15772ad](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/15772ad384ab6494965003d8ff0769fa5dab867f))
* **testing:** add e2e coverage for widget toggle and dictionary navigation ([e39cd5a](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/e39cd5af717ca804d46c9508d058c45381e87081))
* **testing:** add unit tests for core modules, dictionary libs, and stores ([dc1850f](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/dc1850f3d2db5e4c6684a6eb9c54af47efc207f5))
* **testing:** add vitest and [@testing-library](https://gitlab.lavid.ufpb.br/testing-library) for unit tests ([b25f14b](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/b25f14b66f1bd177faf7e48c1a59d34ba18b4fa1))
* **testing:** expand unit test coverage for hooks, actions, and stores ([c63e3bf](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/c63e3bfe4db24aa11306eb1c2e32164679f81e80))
* **widget:** update root active dataset on root sync ([0ae6e7e](https://gitlab.lavid.ufpb.br/vlibras2019/vlibras-web-extensions/vlibras-web-browsers/commit/0ae6e7e028f9e7ab137733cf70c2e894adb94bea))
